...
void GMLOutput::writeHeader(string label, size_t solution, size_t numberOfNodes, size_t numberOfClusters) {
    _os<<"graph ["<<endl;
...
void GMLOutput::writeEdge(int sourceId, int targetId, string name, double weight, bool modified) {
    _os<<"\tedge ["<<endl;
