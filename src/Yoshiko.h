...
public:
	// constructor
    Yoshiko(bool st, bool sp, int num_opt_sol) : _sep_triangles(st), _sep_partition_cuts(sp), _num_opt_sol(num_opt_sol) {};
    long solve(const ClusterEditingInstance& i, ClusterEditingSolutions& s);
private:
    bool _sep_triangles;
